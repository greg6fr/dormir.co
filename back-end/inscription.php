...
$insert = $database->insert($pdo, "lastname,firstname, email, phone, password", " user ", $array, '?,?,?,?,?');
...
$verif->setArray(["Enrgistrement effectué avec succès. Veuillez-vous connecter."]);
header('Location: http://localhost/login.php/?success='."Enrgistrement effectué avec succès. Veuillez-vous connecter"); 