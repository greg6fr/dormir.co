...
//$email = Email::sendEmail($authEmail, $authPassword, "tounde.gregoire@gmail.com", "Parainnage bousorama", "../email/email.html");

if ($_SESSION['email'] ) {
    echo "<script>window.location.assign('/voir-les-annonces.php')</script>";
    return;
}
