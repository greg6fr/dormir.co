...
class Verification {
    ...
    public function Texte($name, $param) {
        return $this->Verif($name, 3, 255, 'Votre '.$param.' est invalide');
    }

    public function Prix($name, $param) {
        return $this->Verif($name, 1, 9, 'Votre '.$param.' est invalide');
    }

    public function TexteArea($name, $param) {
        return $this->Verif($name, 5, 1500, 'Votre '.$param.' est invalide');
    }

    public function Id($name, $param) {
        return $this->Verif($name, 1, 10, 'Votre '.$param.' est invalide');
    }
